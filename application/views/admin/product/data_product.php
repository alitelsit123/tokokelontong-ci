                    ...
                    <input name="nama" type="text" class="form-control m_nama" required />
										...
										<span style="width: 100%;" class="select2-container">
											<select required multiple="multiple" name="ukuran[]" class="form-control ukuran">
												<option value="Coklat" class="m_Coklat">Coklat</option>
											    <option value="Keju" Class ="m_Keju">Keju</option>
												<option value="Coklat Keju" Class = "m_CoklatKeju">Coklat Keju</option>
												<option value="Kecil" Class = "m_Kecil">Kecil</option>
