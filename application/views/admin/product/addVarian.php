          ...
          <div class="">
            ...
            <div class="">
              ...
              <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" action="">
                      ...
                      <input name="Varian" type="text" value="<?= set_value('Varian') ?>" class="form-control" required />
                      <?php echo form_error('Varian', '<div class="text-danger">', '</div>'); ?>
                          <div class="col-md-12 text-center">
                            <button type="reset" class="btn btn-secondary">Batal</button>
                            <button type="submit" name="submit" class="btn btn-primary">Tambah varian</button>
                          </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Data Varian <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                    </ul>
                                        ...
                                        <td class="text-center">
                                            <li role="presentation" class="dropdown" style="list-style: none;">
                                                ...
                                                <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnNonaktif" onclick="set_url('<?= site_url('dashboard/admin/deactive_Varian/' . encrypt_url($key['id_Varian']))  ?>')" data-ket="meng nonaktifkan" data-toggle="modal" data-target="#kt_modal_1">
                                                        Nonaktifkan varian</a>
                                                    </li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnHapus" onclick="set_url('<?= site_url('dashboard/admin/delete_Varian/' . encrypt_url($key['id_Varian']))  ?>')" data-ket="menghapus" data-toggle="modal" data-target="#kt_modal_1">
                                                        Hapus varian</a>
                                                    </li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnEdit" data-toggle="modal" data-target=".bs-example-modal-lg" 
                                                        data-toggle="modal"
                                                        data-id="<?= $key['id_Varian'] ?>"
                                                        data-namaold="<?= $key['Varian'] ?>"
                                                        >
                                                        Edit Varian</a>
                                                    </li>
                                                </ul>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <li role="presentation" class="dropdown" style="list-style: none;">
                                                ...
                                                <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnAktif" onclick="set_url('<?= site_url('dashboard/admin/reactive_Varian/' . encrypt_url($key['id_Varian']))  ?>')" data-ket="mengaktifkan" data-toggle="modal" data-target="#kt_modal_1">
                                                        Aktifkan Varian</a>
                                                    </li>
                                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="btnHapus1" onclick="set_url('<?= site_url('dashboard/admin/delete_Varian/' . encrypt_url($key['id_Varian']))  ?>')" data-ket="menghapus" data-toggle="modal" data-target="#kt_modal_1">
                                                        Hapus Varian</a>
                                                    </li>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Edit varian <span class="text-danger nama-target"></span></h4>
              </div>
              <div class="modal-body">
                <form method="POST" action="<?= base_url('dashboard/admin/update_Varian') ?>">
                
                  <label for="Varian">Nama Varian :</label>
                  <input name="id_Varian_new" type="hidden" value="" class="form-control id_Varian_new" />
                  <input name="nama_Varian_new" type="text" value="" class="form-control nama_Varian_new" required />

                  <div class="col-md-12 text-center">
                    <button type="reset" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <button type="submit" name="submit" class="btn btn-primary">Edit Varian</button>
                  </div>
                </form>
              </div>
            </div>
	...
	<script src="<?= base_url('assets/gentelella/') ?>vendors/pdfmake/build/vfs_fonts.js"></script>
        ...
        $(document).ready(function() {
            $('.btnAktif').on('click', function() {
                ...
                $('#ket_modal').text('Anda yakin ingin ' + ket + ' data varian ini?');
            });
            ...
            $('.btnEdit').on('click', function() {
                ...
                $('.id_Varian_new').val(id);
                $('.nama_Varian_new').val(nama);
