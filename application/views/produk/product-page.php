          ...
          <div class="p-4">
            ...
            <p class="lead">
              <?php if ($produk['diskon'] != 0) {?>
                <span class="mr-1" style="color:#F00; padding-left:10px; font-size:100%; text-decoration:line-through">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    //jika diskon tidak sama dengan 0, berarti ada diskon maka muncul text ini
                        if($items['diskon'] != 0){
                        ?>
                    <span style="color:#F00; padding-left:10px; font-size:14px; text-decoration:line-through;">Rp. <?php echo number_format($items['harga_produk']);?></span>
                    <?php
                        }?>  
                    <strong><h4 class="font-weight-bold blue-text">Rp. <?php echo number_format($items['harga_produk'] - $items['harga_produk'] * $items['diskon'] / 100, 0, ',', '.') ?></strong></h4>
                    <p style="font-size:12px">
                    <strong>Stok tersisa : <?= ($items['stok'] ) ?> </strong>
                  </p>
                  </div>
                </div>
              </div>
