...
class Home extends CI_Controller
{
	...
	public function index()
	{
		...
		// dd($data['cat']);
		$data['title'] = 'Kaisar Products - Home';
	...
	{
		$data['title'] = 'Kaisar Products - Contact';
	...
	{
		$data['title'] = 'Kaisar Products - cara beli';
		$this->load->view('carabeli', $data);
	}
	...
	public function konfirmasi_barang($id_trx, $email)
  {
	...
	{
		$data = [
			'title' => 'Kaisar Products - Keranjang'
		];
